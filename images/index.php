...
$site_url                 = "https://dashwood.net/slideshow/images/";  // url of this module
$site_image_url           = $site_url;                  // url of the image folder
$site_thumb_url           = $site_url . "image/thumb";            // url of the thumb folder
$upload_url               = "./";                           // directory path of the image folder
$upload_thumb_url         = "./thumb/";                     // directory path of the thumb folder
...
if (isset($_FILES) && count($_FILES)>0) {
    ...
    $name     = $NowisTime . str_replace(' ', '-', $_FILES['file']['name']);
...
if(isset($_POST['speed'])) {
    $data = $_POST['speed'] * 1000;
    $ret = file_put_contents('settings.txt', $data);
    if($ret === false) {
        $response = 'There was an error writing this file';
    }
    else {
        $response = "Slider speed set to " . file_get_contents("settings.txt");
    }
}
else {
   $response = 'no post data to process';
}
...
?> 
    ...
    <title>Slideshow Picture Manager</title>
      ...
      <div class="row">
        <div class="col-lg-12">
          <form class="well" action="index.php" method="POST">
            ...
            <label for="file">Enter seconds per slide:</label><br>
        ...
        <div class="col-lg-12">
           <form class="well" action="index.php" method="post" enctype="multipart/form-data">
              <div class="form-group">
                ...
                <p class="help-block">Only jpg,jpeg,png and gif file with maximum size of 10 MB is allowed.</p>
              </div>
